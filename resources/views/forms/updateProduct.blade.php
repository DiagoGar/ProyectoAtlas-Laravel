...
@section('title', 'Edicion de Prodcuto')

@section('form')
  <form action="{{ url('/api/productos/' . $data['product']['idProductos']) }}" method="POST" class="mt-48 bg-orange-500 rounded-xl" style="width: 40vw">
    @csrf
    <div
      ...
      <div class="w-1/2 mr-4">
        ...
        <div class="mb-4">
          ...
          <input
            ...
            value="{{ $data['product']['nobreProducto'] }}"
          />
        </div>
        <div class="mb-4">
          ...
          <input
            ...
            value="{{ $data['product']['pesoProducto'] }}"
          />
        </div>
      ...
      <div class="w-1/2 ml-4">
        ...
        <div class="mb-4">
          ...
          <input
            ...
            value="{{$data['remito']['destinatario']}}"
          />
        </div>
        <div class="mb-4">
